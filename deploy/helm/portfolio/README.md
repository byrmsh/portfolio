...
- `web.env.prometheusUrl` feeds `PROMETHEUS_URL` for `/system-status.json` Prometheus queries.
  - Recommended in-cluster value is `http://grafana-stack-kube-prometh-prometheus.monitoring.svc.cluster.local:9090`.
